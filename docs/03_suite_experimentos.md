...
| E12 — No localidad espontánea | Dos nodos independientes satisfacen `|S| ≤ 2`. | Un valor `S > 2` obtenido tras selección, filtrado o múltiples análisis. | Una violación preregistrada, sin lagunas relevantes y replicada en otra plataforma. |
