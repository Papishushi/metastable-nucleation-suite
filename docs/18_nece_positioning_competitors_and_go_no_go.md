# 18. Posicionamiento de NECE, alternativas y criterios go/no-go

## 18.1 Conclusión ejecutiva
...
## 18.2 Qué ya hacen mejor otras plataformas
...
## 18.3 Competidor conceptual más próximo
...
no volátil basada en Sb2Se3 con programación cerrada `program-and-verify`. Zarei demostró conceptualmente una
red difractiva reescribible con metasuperficies de cambio de fase. Estos trabajos muestran que la idea general
...
## 18.4 Por qué NECE todavía puede merecer la pena
...
## 18.5 Por qué NECE puede fracasar
...
## 18.8 Envolvente cuantitativa provisional
...
## 18.9 Experimento mínimo decisivo
...
## 18.10 Arquitectura recomendada
...
## 18.12 Literatura primaria de comparación
