...
def test_non_integer_state_counts_fail_closed(value: float) -> None:
    with pytest.raises(TypeError, match="must be an integer"):
        _scenario(distinguishable_states=value)
...
def test_invalid_parameters_fail_closed(field: str, value: float) -> None:
